        ...
        <div class="col-span-3 space-y-6">
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <div class="flex items-center gap-3 bg-[#F9FBFF] p-3 rounded-xl border border-[#E5E9F2]">
                            <div class="w-10 h-10 rounded-full bg-[#1273EB] flex items-center justify-center text-white font-bold text-[14px]">EH</div>
            ...
            <div class="space-y-3">
                ...
                <button type="button" 
                    ...
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M14.74 9l-.34 9m-4.72 0l-.34-9m9.27-2.31a44.59 44.59 0 00-4.53-.13m-10.83 0a44.59 44.59 0 00-4.53.13m15.23 0l-1.23-1.87a3.375 3.375 0 00-3.06-1.55h-4.06a3.375 3.375 0 00-3.06 1.55l-1.23 1.87m12.13 0H6.25"></path>
                    </svg>
                    Hapus Data
                </button>
