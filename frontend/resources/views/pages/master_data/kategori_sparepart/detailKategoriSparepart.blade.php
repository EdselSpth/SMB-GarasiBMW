...
<div class="space-y-6">
    <div class="flex items-start border-b border-gray-50 pb-4">
        <p class="w-64 text-[14px] font-medium text-gray-400 uppercase tracking-wide">Nama Kategori</p>
        <p class="text-[14px] font-bold text-[#213F5C]">Rem</p>
    </div>
    <div class="flex items-start border-b border-gray-50 pb-4">
        ...
        <p class="flex-1 text-[14px] font-bold text-[#213F5C] leading-relaxed">
            Kategori untuk semua jenis sparepart yang berkaitan dengan sistem pengereman, mulai dari kampas rem, piringan cakram, hingga minyak rem.
        </p>
    </div>
</div>
@endsection
