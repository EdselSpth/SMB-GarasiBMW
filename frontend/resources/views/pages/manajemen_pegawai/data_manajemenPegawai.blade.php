...
@section('content')
    ...
    @include('layouts.action_bar', ['placeholder' => 'Cari nama atau email...', 'btnText' => 'Tambah Karyawan'])
                ...
                <tbody class="divide-y divide-[#F0F4F8]">
                    ...
                    @foreach($data as $item)
                        <tr class="hover:bg-[#F9FCFF] transition-colors group">
                            ...
                            <td class="px-[24px] py-[18px] text-[#213F5C] font-semibold text-[13px]">{{ $item['durasi_kerja'] }}
                            </td>
