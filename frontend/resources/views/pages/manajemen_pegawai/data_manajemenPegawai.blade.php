...
@section('content')
    ...
    <header class="bg-white rounded-[12px] border border-[#D9E2EC] p-[16px] flex items-center justify-between shadow-sm mb-[20px]">
        <h2 class="text-[20px] font-bold text-bmw-dark">Manajemen Karyawan</h2>
    ...
    <div class="flex items-center justify-between mb-[20px]">
        ...
        <div class="relative w-[340px]">
            ...
            <input type="text" placeholder="Cari Karyawan" class="w-full pl-[40px] pr-[16px] py-[12px] bg-white border border-[#D9E2EC] rounded-[10px] outline-none shadow-sm focus:border-bmw-blue focus:ring-1 focus:ring-bmw-blue/20 transition-all text-[14px]">
        </div>
            ...
            <table class="w-full text-left">
                <thead class="bg-white border-b border-[#D9E2EC]">
                    <tr class="text-[11px] font-bold text-[#627D98] uppercase tracking-[0.05em]">
                        <th class="px-[24px] py-[20px]">Nama</th>
                        <th class="px-[24px] py-[20px]">Email</th>
                        <th class="px-[24px] py-[20px]">Durasi kerja</th>
                        <th class="px-[24px] py-[20px]">Role</th>
                        <th class="px-[24px] py-[20px]">Status</th>
                ...
                <tbody class="divide-y divide-[#F0F4F8]">
                    ...
                    <tr class="hover:bg-[#F9FCFF] transition-colors group">
                        <td class="px-[24px] py-[18px] font-bold text-[#213F5C]">{{ $item['nama'] }}</td>
                        <td class="px-[24px] py-[18px] text-[#213F5C] font-semibold text-[13px]">{{ $item['email'] }}</td>
                        <td class="px-[24px] py-[18px] text-[#213F5C] font-semibold text-[13px]">{{ $item['durasi_kerja'] }}</td>
                        <td class="px-[24px] py-[18px] text-[#213F5C] font-semibold text-[13px]">{{ $item['role'] }}</td>
                        <td class="px-[24px] py-[18px] text-[#213F5C] font-semibold text-[13px]">{{ $item['status'] }}</td>
